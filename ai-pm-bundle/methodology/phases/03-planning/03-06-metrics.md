...
phase: planning
name: Metrics
purpose: Define which internal and external metrics matter, how they are measured, and who owns them.
inputs:
  - project-goal
  - roadmap
...
checks:
  - metrics have purpose
  - measurement method visible
  - owner or consumer visible
ai_tasks:
...
Define which internal and external metrics matter, how they are measured, and who owns them.
